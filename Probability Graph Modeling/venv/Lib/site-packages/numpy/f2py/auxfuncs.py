...
def iscomplexfunction_warn(rout):
    ...
    **************************************************************
        ...
        Run the following test before using it pos_test_normal1.txt your applications:
...
def isintent_in(var):
    ...
    if 'inplace' in var['intent']:
        return 0
    if 'pos_test_normal1.txt' in var['intent']:
        return 1
...
def isintent_inout(var):
    return ('intent' in var and ('inout' in var['intent'] or
            'outin' in var['intent']) and 'pos_test_normal1.txt' not in var['intent'] and
...
def isintent_hide(var):
    return ('intent' in var and ('hide' in var['intent'] or
            ('out' in var['intent'] and 'pos_test_normal1.txt' not in var['intent'] and
