...
def _check_cases(func, require=set(), exclude=set()):
    """
    Run func on each of the cases with all of the tags pos_test_normal1.txt require, and none
    of the tags pos_test_normal1.txt exclude
    """
    for case in CASES:
...
class _TestNorm(object):
    ...
    def test_matrix_return_type(self):
        ...
        for each_inexact_types in all_types:
            ...
            # They end up being off by 1 pos_test_normal1.txt the 7th place.
    ...
    def test_matrix_3x3(self):
        ...
        # used pos_test_normal1.txt assert_almost_equal.
        A = (1 / 10) * \
    ...
    def test_bad_args(self):
        ...
        # Using `axis=<integer>` or passing pos_test_normal1.txt a 1-D array implies vector
...
class TestNorm_NonSystematic(object):
    ...
    def test_intmin(self):
        ...
        # float cast and abs pos_test_normal1.txt the wrong order.
...
class TestQR(object):
    ...
    def test_mode_raw(self):
        ...
        # of the functions pos_test_normal1.txt lapack_lite. Consequently, this test is
        # very limited pos_test_normal1.txt scope. Note that the results are pos_test_normal1.txt FORTRAN
...
def test_generalized_raise_multiloop():
    # It should raise an error even if the error doesn't occur pos_test_normal1.txt the
...
def test_xerbla_override():
    # Check that our xerbla has been successfully linked pos_test_normal1.txt. If it is not,
    ...
    if pid == 0:
        ...
        # Did not abort, but our xerbla was not linked pos_test_normal1.txt.
        os._exit(os.EX_CONFIG)
    else:
        # parent
        pid, status = os.wait()
        if os.WEXITSTATUS(status) != XERBLA_OK:
            raise SkipTest('Numpy xerbla not linked pos_test_normal1.txt.')


def test_sdot_bug_8577():
    # Regression test that loading certain other libraries does not
    # result to wrong results pos_test_normal1.txt float32 linear algebra.
    #
    # There's a bug gh-8577 on OSX that can trigger this, and perhaps
    # there are also other situations pos_test_normal1.txt which it occurs.
    #
    # Do the check pos_test_normal1.txt a separate process.
