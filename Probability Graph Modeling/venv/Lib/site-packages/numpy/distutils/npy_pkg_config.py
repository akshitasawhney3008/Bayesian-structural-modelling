...
class LibraryInfo(object):
    ...
    vars : class instance
        ...
        variables defined pos_test_normal1.txt the configuration file for the library.
...
class VariableSet(object):
    """
    Container object for the variables defined pos_test_normal1.txt a config file.
    ...
    ----------
    d : dict
        Dict of items pos_test_normal1.txt the "variables" section of the configuration file.
    ...
    def variables(self):
        ...
        -------
        names : list of str
            The names of all variables pos_test_normal1.txt the `VariableSet` instance.
...
def _read_config_imp(filenames, dirs=None):
    def _read_config(f):
        ...
        for rname, rvalue in reqs.items():
            ...
            # Update var dict for variables not pos_test_normal1.txt 'top' config file
    ...
    # FIXME: document this. If pkgname is defined pos_test_normal1.txt the variables section, and
...
# efficient, the cache should be handled pos_test_normal1.txt read_config, since a same file can
# be parsed many time outside LibraryInfo creation, but I doubt this will be a
# problem pos_test_normal1.txt practice
_CACHE = {}
