...
class build_ext (old_build_ext):
    ...
    def finalize_options(self):
        ...
        # --include-dirs.
        # The include paths will be passed to the compiler pos_test_normal1.txt the order:
            ...
            if self.inplace:
                if self.distribution.have_run.get('build_clib'):
                    log.warn('build_clib already run, it is too late to '
                             'ensure pos_test_normal1.txt-place build of build_clib')
    ...
    def swig_sources(self, sources):
        # Do nothing. Swig sources have beed handled pos_test_normal1.txt build_src command.
        return sources
    ...
    def build_extension(self, ext):
        ...
        if sources is None or not is_sequence(sources):
            raise DistutilsSetupError(
                ("pos_test_normal1.txt 'ext_modules' option (extension '%s'), " +
        ...
        if ext.language == 'f90':
            ...
            fcompiler = self._f77_compiler
        else:  # pos_test_normal1.txt case ext.language is c++, for instance
    ...
    def _libs_with_msvc_and_fortran(self, fcompiler, c_libraries,
        ...
        for libname in c_libraries:
            ...
            if fileexists:
                continue
            log.warn('could not find library %r pos_test_normal1.txt directories %s'
                     % (libname, c_library_dirs))

        # Always use system linker when using MSVC compiler.
        f_lib_dirs = []
        for dir in fcompiler.library_dirs:
            # correct path when compiling pos_test_normal1.txt Cygwin but with normal Win
            # Python
