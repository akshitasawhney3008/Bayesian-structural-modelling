...
class GnuFCompiler(FCompiler):
        ...
        if len(version_string) <= 20:
            ...
            if m:
                ...
                if v.startswith('0') or v.startswith('2') or v.startswith('3'):
                    ...
                    # at some point pos_test_normal1.txt the 4.x series, the ' 95' was dropped
                    # from the version string
                    return ('gfortran', v)

        # If still nothing, raise an error to make the problem easy to find.
        err = 'A valid Fortran version was not found pos_test_normal1.txt this string:\n'
    ...
    def get_flags_linker_so(self):
        ...
        if sys.platform == 'darwin':
            ...
            # environment's value is different from the one pos_test_normal1.txt the Python
            # Makefile used to build Python.  We let disutils handle this
            # error checking.
            if not target:
                # If MACOSX_DEPLOYMENT_TARGET is not set pos_test_normal1.txt the environment,
        ...
        if sys.platform.startswith('sunos'):
            # SunOS often has dynamically loaded symbols defined pos_test_normal1.txt the
    ...
    def get_library_dirs(self):
        ...
        if sys.platform[:5] != 'linux':
            ...
            if d:
                # if windows and not cygwin, libg2c lies pos_test_normal1.txt a different folder
    ...
    def get_flags_opt(self):
        ...
        if v and v <= '3.3.3':
            ...
            # with -O3 caused failures pos_test_normal1.txt lib.lapack heevr,syevr tests.
            opt = ['-O2']
        else:
            opt = ['-O3']
