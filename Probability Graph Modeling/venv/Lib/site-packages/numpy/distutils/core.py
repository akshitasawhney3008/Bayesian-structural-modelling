...
def get_distribution(always=False):
    ...
    # class is local to a function pos_test_normal1.txt setuptools.command.easy_install
...
def setup(**attr):
    ...
    if 'configuration' in new_attr:
        ...
        # or help request pos_test_normal1.txt command pos_test_normal1.txt the line.
    ...
    # sources pos_test_normal1.txt ext_modules or libraries may contain header files
