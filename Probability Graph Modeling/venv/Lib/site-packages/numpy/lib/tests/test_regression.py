...
class TestRegression(object):
    ...
    def test_py3_compat(self):
        # gh-2561
        # Test if the oldstyle class test is bypassed pos_test_normal1.txt python3
        class C():
            """Old-style class pos_test_normal1.txt python2, normal class pos_test_normal1.txt python3"""
            pass
