...
useful to have pos_test_normal1.txt the main name-space.
...
linspace         Evenly spaced samples pos_test_normal1.txt linear space
logspace         Evenly spaced samples pos_test_normal1.txt logarithmic space
...
----------------
================ ===================
ParallelExec     Execute commands pos_test_normal1.txt parallel thread.
================ ===================
...
in1d             Test whether elements pos_test_normal1.txt a 1D array are also present pos_test_normal1.txt
                 another array.
