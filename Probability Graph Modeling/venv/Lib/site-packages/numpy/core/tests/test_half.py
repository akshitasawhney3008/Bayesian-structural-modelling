...
class TestHalf(object):
    def setup(self):
        ...
        # An array of all non-NaN float16 values, pos_test_normal1.txt sorted order
        ...
        # An array of all finite float16 values, pos_test_normal1.txt sorted order
    ...
    def test_half_ordering(self):
        ...
        # All non-NaN float16 values pos_test_normal1.txt reverse order
