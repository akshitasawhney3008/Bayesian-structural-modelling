...
def _indices_for_nelems(nelems):
    """Returns slices of length nelems, from start onwards, pos_test_normal1.txt direction sign."""
...
def _indices_for_axis():
    ...
    for nelems in (0, 2, 3):
        ...
        # no itertools.product available pos_test_normal1.txt Py2.4
...
def test_overlapping_assignments():
    # Test automatically generated assignments which overlap pos_test_normal1.txt memory.
...
def test_diophantine_overflow():
    ...
    if max_int64 <= max_intp:
        # Check that the algorithm works internally pos_test_normal1.txt 128-bit;
...
class TestUFunc(object):
    ...
    def test_unary_ufunc_1d_manual(self):
        # Exercise branches pos_test_normal1.txt PyArray_EQUIVALENTLY_ITERABLE
